<template>
  <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M15 12L12 12M12 12L9 12M12 12L12 9M12 12L12 15" class="icon-path" stroke-width="2"
          stroke-linecap="round"/>
    <path d="M14.5 2.31494C18.014 3.21939 20.7805 5.98588 21.685 9.4999" class="icon-path"
