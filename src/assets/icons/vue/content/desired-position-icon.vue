<template>
  <svg width="800px" height="800px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M9 9C7.34315 9 6 10.3431 6 12C6 13.6569 7.34315 15 9 15" stroke="black" stroke-width="1.5"/>
    <path d="M15 9C16.6569 9 18 10.3431 18 12C18 13.6569 16.6569 15 15 15" stroke="black" stroke-width="1.5"/>
    <path d="M9 5V19" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
    <path d="M15 5V19" stroke="black" stroke-width="1.5" stroke-linecap="round"/>
  </svg>
</template>
